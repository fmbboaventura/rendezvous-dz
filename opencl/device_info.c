...
int output_device_info(cl_device_id device_id)
{
    ...
    if (err != CL_SUCCESS)
    {
        printf("Erro: falha ao recuperar o nome do device!\n");
        return EXIT_FAILURE;
    }
    ...
    if (err != CL_SUCCESS)
    {
        printf("Erro: falha ao acessar o tipo do device!\n");
        return EXIT_FAILURE;
    }
    ...
    if (err != CL_SUCCESS)
    {
        printf("Erro: Falha ao recuperar o numero de compute units !\n");
        return EXIT_FAILURE;
    }
    printf(" com um maximo de %d compute units \n",comp_units);
...
//
    ...
    if (err != CL_SUCCESS)
    {
        printf("Erro: Falha ao recuperar as informações do device (CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS)!\n",
                                                                            err_code(err));
        return EXIT_FAILURE;
    }
    ...
    if (err != CL_SUCCESS)
    {
        printf("Erro: Falha ao recuperar as informações do device (CL_DEVICE_MAX_WORK_ITEM_SIZES)!\n",err_code(err));
        return EXIT_FAILURE;
    }
    ...
    if (err != CL_SUCCESS)
    {
        printf("Erro: Falha ao recuperar as informações do device (CL_DEVICE_MAX_WORK_GROUP_SIZE)!\n",err_code(err));
        return EXIT_FAILURE;
    }
